...
- Some console features doesn't work inside turbo which handles the development run.<br />To make sure the console features work while you develop you can run **`yarn dev:packages`** to watch changes only in _packages/_ and then **`yarn dev:terminal`** to start development outside turbo environment
